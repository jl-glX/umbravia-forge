              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                {overview?.trial.status === "trial_active" && (
                  <div className="md:col-span-2">
                    ...
                    <div className="mt-2 flex items-stretch overflow-hidden rounded-md border border-slate-200 bg-white focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-100">
                      <input
                        id="subdomain"
                        required
                        minLength={1}
                      ...
                      {overview.environment.tenantBaseDomain && (
                        <span className="flex shrink-0 items-center border-l border-slate-300 bg-slate-100 px-3 font-mono text-sm font-semibold text-slate-600">
                          .{overview.environment.tenantBaseDomain}
                        </span>
                      )}
                    </div>
